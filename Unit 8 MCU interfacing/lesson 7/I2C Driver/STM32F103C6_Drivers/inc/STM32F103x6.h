...
//maps each interrupt to its port number in the NVIC
//-*-*-*-*-*-*-*-*-*-*-*--*-*-*-*-*-*-*-*-*-*-*--*-*-*-*-*-*-*-*-*-*-*--*-*-*-*-*-*-*-*-
//EXTI
...
#define NVIC_IRQ40_EXTI10_to_EXTI15_disable()   (NVIC_ICPR1|=(1<<(EXTI10_IRQ-32)))
...
#define NVIC_IRQ31_I2C1_EV_disable()                (NVIC_ICPR0|=(1<<I2C1_EV_IRQ))
#define NVIC_IRQ32_I2C1_ER_disable()                (NVIC_ICPR1|=(1<<(I2C1_ER_IRQ-32)))
#define NVIC_IRQ33_I2C2_EV_disable()                (NVIC_ICPR1|=(1<<(I2C2_EV_IRQ-32)))
#define NVIC_IRQ34_I2C2_ER_disable()                (NVIC_ICPR1|=(1<<(I2C2_ER_IRQ-32)))
